# Generated by Powerlevel10k configuration wizard on 2019-12-24 at 09:55 PST.
...
# solid, no frame, light, sparse, few icons, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_VERBOSE_SIGNAME=true #false
